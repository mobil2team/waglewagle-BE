...
public class PostController {
    ...
    public ResponseEntity<PageResponseDto<PostListDto>> getPostList(
            ...
            @RequestParam(value = "pageSize", defaultValue = "20") @Parameter(description = "페이지 한 개당 요청할 게시글 수", required = true, example = "5") Integer pageSize,
            @RequestParam(value = "pageNumber", defaultValue = "1") @Parameter(description = "요청하는 페이지 번호 (1부터 시작)", required = true, example = "1") Integer pageNumber,
